...
Each build will publish tags using combinations of the Node.js and Python versions, for maximum flexibility. For example, with `NODE_VERSION=18.20.8` and `PYTHON_VERSION=3.10.20`, tags created are:
...
```sh
docker pull mosathip/node-alpine-with-python:18.20.8-3.10.20
```
